    ...
    <div class="register">
      ...
      >
        ...
        <el-form-item label="Laboratory" prop="laboratory">
          ...
          >
            <el-option
              v-for="item in all_lab"
              :key="item.lab"
              :value="item.lab"
            ></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="Name" prop="stuffName"
          ><el-input class="input" v-model="ruleForm.stuffName"></el-input
        ></el-form-item>
    ...
    return {
      ...
      rules: {
        company: [
          {
            required: true,
            validator: this.changeCompany,
            trigger: ["change"],
          },
        ],
        laboratory: [
          { required: true, validator: this.changeLab, trigger: ["change"] },
        ],
        stuffName: [
  ...
  methods: {
    ...
    validatePass(rule, value, callback) {
      if (value === "") {
        ...
        callback(
          new Error("8-16个字符，至少1个大写字母、1个小写字母、1个数字")
        );
        return false;
      } else {
