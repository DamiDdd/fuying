<template>
  <div class="windows">
    <el-row class="topRow">
      <el-input class="short-input" v-model="search_num"></el-input>
    ...
    <el-table
      ...
      <el-table-column label="创建日期" prop="createtime" width="230"></el-table-column>
...
export default {
  ...
  mounted(){
    Axios.post(this.getAllUrl).then((response) => {
  ...
  methods:{
    ...
    changeTableSort(column){
      ...
      if(sortingType == "descending"){
        console.log(fieldName+"降序");
      }
      else{
        console.log(fieldName+"升序");
      }
      console.log(this.selected_data)
    },
