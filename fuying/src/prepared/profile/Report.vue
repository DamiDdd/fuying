  ...
  <div id="report">
    ...
    <div id="report-div">
      ...
      <div class="main-div">
        ...
        <p class="main-text">
          iproteome健康（上海iproteome生物科技有限公司）是生命健康领域的新兴企业，坚持自主创新和成果转化，立足新一代蛋白质
        ...
        <p class="main-text">
          在此我们也特别提醒您注意：受检者委托iproteome健康开展蛋白质组学生理刻画检测服务，系基于受检者生理功能相关评估结
        ...
        <p class="main-text">
          希望您能将您的宝贵意见与建议及时反馈给我们。我们免费的服务电话是{{
            phone
          }}（工作日，8:30-17:30），我们将竭诚 为您服务！祝您健康！
        </p>
        <p class="main-text">此致</p>
        <p class="main-text" style="text-indent: 0;">敬礼!</p>
        <p class="main-text" style="text-align: right;">
          上海iproteome生物科技有限公司
        </p>
      </div>
      ...
      <img-paper>
        ...
        <p slot="text1">
          您的身体脂肪率指数在万人队列中的位比为36.35%，处在正
          常位区，表示您的身体脂肪率指数水平低于63.65%的人群，您的状态正常，请继续保持。
        </p>
        <p slot="title2">1.3.1 丙氨酸氨基转移酶指数</p>
        <img src="~assets/img/report/temp/1.3.1.png" slot="img2" />
        <p slot="text2">
          您的丙氨酸氨基转移酶指数在万人队列中的位比为52.73%，处在正常位区，
          表示您的丙氨酸氨基转移酶指数水平低于47.27%的人群，您的状态正常，请继续保持。
        </p>
      </img-paper>
      <img-paper>
        ...
        <p slot="text1">
          您的天冬氨酸氨基转移酶指数在万人队列中的位比为69.69%，处在正常位区，
          表示您的天冬氨酸氨基转移酶指数水平低于30.31%的人群，您的状态正常，请继续保持。
        </p>
      </img-paper>
    </div>
  </div>
  ...
  methods: {
    ...
    handleDownload() {
      DownloadPDF.downloadPDF(
        document.querySelector("#report-div"),
        "user-report"
      );
    }
  }
